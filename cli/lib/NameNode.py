import lib.NN_Support as n_su
import lib.dfs_tree as tr
from datetime import datetime
import lib.DataNode as dn
import pickle as pk
import os
...
class NameNode:
    ...
    def put(self,file_path,dfs_file_path):
        ...
        try:
            ...
            raise ValueError("Poor destination file path")
        ...
        if c == 0:
            raise ValueError("File or directory of same name exists")
    ...
    def cat(self,dfs_file_path,output_file_path = None):

        file_loc = dfs_file_path.split(tr.delim)
        try:
            assert self.fs_image.check_path(file_loc).isDir == False
        except:
            raise ValueError("File dosen't exist in this location")
    ...
    def ls(self,dfs_dir_path):
        ...
        try:
            ...
            raise ValueError("Directory dosen't exist in this location")
    ...
    def mkdir(self,new_dir_path):
        ...
        try:
            self.fs_image.create_node(new_dir_loc[:-1],new_dir_loc[-1],isdir = True,contents = [])
            self.create_checkpoint()
    ...
    def rmdir(self,rem_dir_path):
        ...
        try:
            ...
            raise ValueError("Path dosen't correspond to directory")
